#!/usr/bin/env python from __future__ import absolute_import, unicode_literals
...
#/home/victoria88/webapps/secdeploy_cartridge/cartridge/cartridge/project_template
sys.path.insert(0,'/home/victoria88/webapps/secdeploy_cartridge/cartridge')
sys.path.insert(0,'/home/victoria88/webapps/secdeploy_cartridge/cartridge/cartridge')
#sys.path.insert(0, os.path.abspath(os.path.join(PROJECT_ROOT, "..")))
print 'what?'+os.path.abspath(os.path.join(PROJECT_ROOT, ".."))
