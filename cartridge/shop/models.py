...
class Product(Displayable, Priced, RichText, AdminThumbMixin):
    ...
    """
    hotsale = models.BooleanField(_("Hot sale"),
                                    default=False)
    onslide = models.BooleanField(_("On slide"),
                                    default=False)
    preorder =models.BooleanField(_("Pre order"),
                                    default=False)
...
class ProductVariationMetaclass(ModelBase):
    ...
    decoration class :
    self is  a instance , cls  is a class
    bases: base class , attrs: new class attrs (is a dict)
    """
...
class Order(models.Model):
    ...
    billing_detail_postcode = CharField(_("Postcode"), max_length=10)
    billing_detail_country = CharField(_("Country"), max_length=100,choices=COUNTRY,default='AUS')
    ...
    shipping_detail_postcode = CharField(_("Postcode"), max_length=10)
    shipping_detail_country = CharField(_("Country"), max_length=100,choices=COUNTRY,default='AUS')
