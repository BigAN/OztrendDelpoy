...
product_fieldsets[0][1]["fields"][1] = ("status", "available","hotsale","preorder","onslide")
...
product_list_display = ["admin_thumb", "title", "status", "available","hotsale","preorder","onslide",
                        "admin_link"]
product_list_editable = ["status", "available","hotsale","preorder","onslide"]
...
class ProductAdmin(DisplayableAdmin):
    ...
    list_filter = ("status", "available", "hotsale", "preorder", "onslide", "categories")
